...
PORTFOLIO_CATEGORIES = {
    ...
    "EV & Future Mobility":  ["UBER", "XPEV", "7489.HK", "601689.SS", "EH", "JOBY", "EVTL"],
    ...
    "Macro / Index / Hedges": ["GLD", ".VIX", "^HSI", "^KS11", "SCHR", "CBRS"],
}
