...
2. Earnings surprise tracker — log beat/miss history per ticker, surface in deep dive
3. Macro regime detector — yield curve + credit spreads → risk-on / risk-off / stagflation label
